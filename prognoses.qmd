...
: Enkele maatstaven voor de naukeurigheid van prognoses.
:::
...
::: {.callout-note title="Naïeve prognose bij seizoenscomponent"}
...
::: {.callout-note title="Wanneer ETS methode gebruiken?"}
...
: Voorspelde waarden en betrouwbaarheidsgrenzen.
:::
::::
