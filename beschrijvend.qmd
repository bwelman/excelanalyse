...
::: {.callout-note title="Matrixformule"}
...
::: {.callout-tip title="Excel formule"}
...
::: {.callout-tip appearance="minimal" icon="false" title="Excel formules"}
...
::: {.callout-note title="Verschillende waarden voor Kwartielen"}
...
::: {.callout-note title="Kurtosis in de financiële wereld"}
...
::: {.callout-note title="Informatie uit een boxplot halen"}
