...
Bij het verklaren van de waarden van variabelen op basis van de waarden van andere variabelen is het belangrijk om de verschillende rollen van de variabelen duidelijk van elkaar te onderscheiden. In de praktijk kom je verschillende benamingen voor deze rollen tegen:

-  **onafhankelijke variabelen** of **voorspellers**: de variabelen die je gebruikt om iets te verklaren.

-  **afhankelijke variabelen** of **uitkomsten**: de variabelen die worden verklaard.
...
::: {.callout-tip title="Excel formules"}
...
::: {.callout-important title="Geen oorzakelijk verband"}
