...
### Via Werkbladformules {.unnumbered}
...
### Via Spreidingsdiagram {.unnumbered}
...
::: callout-tip
Voor de uitvoering in Excel kies je [Gegevens \> Gegevensanalyse \> Regressie]{.uicontrol}. Let er op dat je beide onafhankelijke variabelen in het invoerbereik voor `x` opneemt, zie @fig-ecdata-regressie.
